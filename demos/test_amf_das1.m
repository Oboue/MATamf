...
annotation(gcf,'textbox',...
    [0.194333333333333 0.587831207065747 0.0234444444444444 0.0235525024533872],...
    'String',{'1'},...
    'FontWeight','bold',...
    'FontSize',25,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'textbox',...
    [0.357666666666667 0.588812561334636 0.0234444444444445 0.0235525024533872],...
    'String','2',...
    'FontWeight','bold',...
    'FontSize',25,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'textbox',...
    [0.502111111111111 0.587831207065744 0.0234444444444444 0.0235525024533872],...
    'String','3',...
    'FontWeight','bold',...
    'FontSize',25,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'textbox',...
    [0.667666666666667 0.588812561334635 0.0234444444444445 0.0235525024533872],...
    'String','4',...
    'FontWeight','bold',...
    'FontSize',25,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'textbox',...
    [0.817666666666667 0.587831207065743 0.0234444444444445 0.0235525024533872],...
    'String','5',...
    'FontWeight','bold',...
    'FontSize',25,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'line',[0.288888888888889 0.288888888888889],...
    [0.925398429833169 0.582924435721295],'LineWidth',3);
annotation(gcf,'line',[0.442222222222222 0.442222222222222],...
    [0.925398429833165 0.582924435721292],'LineWidth',3);
annotation(gcf,'line',[0.597777777777778 0.6],...
    [0.923435721295387 0.584887144259077],'LineWidth',3);
annotation(gcf,'line',[0.75 0.75],[0.925398429833169 0.584887144259077],...
    'LineWidth',3);
...
annotation(gcf,'textbox',...
    [0.179888888888889 0.116781157998037 0.0245555555555556 0.0215897939156032],...
    'String',{'1'},...
    'FontWeight','bold',...
    'FontSize',25,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'textbox',...
    [0.316555555555556 0.1099116781158 0.0201111111111111 0.028459273797841],...
    'String',{'2'},...
    'FontWeight','bold',...
    'FontSize',25,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'textbox',...
    [0.442111111111111 0.108930323846909 0.0212222222222223 0.0294406280667315],...
    'String',{'3'},...
    'FontWeight','bold',...
    'FontSize',25,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'textbox',...
    [0.574333333333333 0.108930323846909 0.0256666666666667 0.0294406280667315],...
    'String',{'4'},...
    'FontWeight','bold',...
    'FontSize',25,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'textbox',...
    [0.7 0.110893032384691 0.0288888888888889 0.0284592737978401],...
    'String',{'5'},...
    'FontWeight','bold',...
    'FontSize',25,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'textbox',...
    [0.827666666666667 0.1099116781158 0.029 0.0284592737978411],'String',{'6'},...
    'FontWeight','bold',...
    'FontSize',25,...
    'FitBoxToText','off',...
    'EdgeColor','none');
...
annotation(gcf,'rectangle',...
    ...
    'Color',[1 0 0],...
    'LineWidth',3);
annotation(gcf,'line',[0.257777777777778 0.26],...
    [0.451422963689892 0.107948969578018],'LineWidth',3);
annotation(gcf,'line',[0.393333333333333 0.393333333333333],...
    [0.44946025515211 0.107948969578017],'LineWidth',3);
annotation(gcf,'line',[0.517777777777778 0.517777777777778],...
    [0.451422963689892 0.108930323846909],'LineWidth',3);
annotation(gcf,'line',[0.651111111111111 0.651111111111111],...
    [0.449441609421001 0.107948969578018],'LineWidth',3);
annotation(gcf,'line',[0.775555555555556 0.777777777777778],...
    [0.450441609421001 0.107948969578018],'LineWidth',3);
...
annotation(gcf,'textarrow',[0.534395670854661 0.552430555555556],...
    [0.793549822881648 0.759037845477145],'Color',[1 0 0],'TextColor',[1 0 0],...
    'String',{'High-amplitude','erratic noise'},...
    'LineWidth',2,...
    'HorizontalAlignment','center',...
    'FontWeight','bold',...
...
annotation(gcf,'textarrow',[0.446666666666667 0.486666666666667],...
    [0.210009813542688 0.17468105986261],'Color',[1 0 0],'TextColor',[1 0 0],...
    'String',{},...
    'LineWidth',2,...
    'HorizontalAlignment','center',...
    'FontWeight','bold',...
    'FontSize',14,...
    'FontName','Helvetica Neue');
annotation(gcf,'textarrow',[0.714373437285703 0.746666666666667],...
    [0.21862783869837 0.18351324828263],'Color',[1 0 0],'TextColor',[1 0 0],...
    'String',{'Improved','signal energy'},...
    'LineWidth',2,...
    'HorizontalAlignment','center',...
    'FontWeight','bold',...
...
annotation(gcf,'textbox',...
    [0.178777777777778 0.11383709519136 0.0234444444444444 0.0235525024533874],...
    'String',{'1'},...
    'FontWeight','bold',...
    'FontSize',25,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'textbox',...
    [0.312111111111111 0.113837095191358 0.0234444444444445 0.0235525024533874],...
    'String','2',...
    'FontWeight','bold',...
    'FontSize',25,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'textbox',...
    [0.447666666666667 0.113837095191358 0.0234444444444444 0.0235525024533873],...
    'String','3',...
    'FontWeight','bold',...
    'FontSize',25,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'textbox',...
    [0.569888888888889 0.114818449460247 0.0234444444444445 0.0235525024533875],...
    'String','4',...
    'FontWeight','bold',...
    'FontSize',25,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'textbox',...
    [0.696555555555555 0.113837095191357 0.0234444444444445 0.0235525024533874],...
    'String','5',...
    'FontWeight','bold',...
    'FontSize',25,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'textbox',...
    [0.826555555555555 0.114818449460248 0.0234444444444445 0.0235525024533872],...
    'String','6',...
    'FontWeight','bold',...
    'FontSize',25,...
    'FitBoxToText','off',...
