...
tic
d_drr1=amf_fxydrr(dinl,flow,fhigh,dt,N,K,verb);    
toc
...
x=1:n2;
ngap=1;
d1_d1=[dcl,ones(n1,ngap),dnl]; % Noisy
d1_d2=[d_bp1,ones(n1,ngap),dnl-d_bp1]; % BP
d1_d3=[d_sosvmf1,ones(n1,ngap),dnl-d_sosvmf1]; % SOSVMF
d1_d4=[d_fk1,ones(n1,ngap),dnl-d_fk1]; % FK
d1_d5=[d_ct1,ones(n1,ngap),dnl-d_ct1]; % Curvelet
d1_d6=[d_amf1,ones(n1,ngap),dnl-d_amf1];% AMF
d1_d7=[d_drr1,ones(n1,ngap),dnl-d_drr1];% drr
...
tic
d_drr2=amf_fxydrr(din,flow,fhigh,dt,N,K,verb);  
toc
% amf_snr(dc,d_drr) % drr
%%
t=[0:n1]*0.004;
x=1:n2;
ngap=2;
d_d1=[dc,ones(n1,ngap),dn]; %Noisy
d_d2=[d_bp,ones(n1,ngap),dn-d_bp]; % BP
d_d3=[d_sosvmf,ones(n1,ngap),dn-d_sosvmf]; % SOSVMF
d_d4=[d_fk,ones(n1,ngap),dn-d_fk]; % FK
d_d5=[d_ct,ones(n1,ngap),dn-d_ct]; % Curvelet
d_d6=[d_amf,ones(n1,ngap),dn-d_amf]; % AMF
d_d7=[d_drr2,ones(n1,ngap),dn-d_drr2]; % drr
...
subplot(3,2,6); imagesc(x,t,d1_d7);colormap(amf_seis);hold on
text(n1/-40,-0.2,'(f)','color','k','Fontsize',16,'fontweight','bold','HorizontalAlignment','center');
text(n2/3.5,-0.08,'DRR','color','k','Fontsize',16,'fontweight','bold','HorizontalAlignment','center');
text(n2/1.3,-0.08,'Removed noise','color','k','Fontsize',16,'fontweight','bold','HorizontalAlignment','center');
colormap(amf_seis);caxis([-0.6,0.6]);
ylabel('Time (s)','Fontsize',16,'fontweight','bold');
xlabel('Panel','Fontsize',16,'fontweight','bold');
...
annotation(gcf,'textarrow',[0.803333333333334 0.791111111111111],...
    [0.269113244297436 0.290937809169664],'Color',[1 0 0],'TextColor',[1 0 0],...
    'LineWidth',3,...
    'HeadWidth',25,...
    'HeadLength',15,...
    'FontWeight','bold',...
    'FontSize',18);
annotation(gcf,'textarrow',[0.84 0.827777777777777],...
    [0.233784490617357 0.255609055489585],'Color',[1 0 0],'TextColor',[1 0 0],...
    'LineWidth',3,...
    'HeadWidth',25,...
    'HeadLength',15,...
    'FontWeight','bold',...
    'FontSize',18);
annotation(gcf,'textarrow',[0.802222222222222 0.783333333333333],...
    [0.23821802005549 0.258522588583406],'Color',[1 0 0],'TextColor',[1 0 0],...
    'String',{'Visible','signal','leakage'},...
    'LineWidth',3,...
    'HeadWidth',25,...
    'HeadLength',15,...
    'FontWeight','bold',...
    'FontSize',18);
annotation(gcf,'textarrow',[0.631111111111111 0.668888888888889],...
    [0.281648675171736 0.303695414665246],'Color',[1 0 0],'TextColor',[1 0 0],...
    'LineWidth',3,...
    'HeadWidth',25,...
    'HeadLength',15,...
    'FontWeight','bold',...
    'FontSize',18);
annotation(gcf,'textarrow',[0.632222222222222 0.67],...
    [0.114818449460255 0.136865188953765],'Color',[1 0 0],'TextColor',[1 0 0],...
    'LineWidth',3,...
    'HeadWidth',25,...
    'HeadLength',15,...
    'FontWeight','bold',...
...
annotation(gcf,'textbox',...
    [0.201111111111111 0.712463199214914 0.0211111111111111 0.0196084396467121],...
    'String',{'1'},...
    'FontWeight','bold',...
    'FontSize',20,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'textbox',...
    [0.367666666666667 0.713444553483805 0.019 0.0186457311089293],...
    'String',{'2'},...
    'FontWeight','bold',...
    'FontSize',20,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'textbox',...
    [0.642111111111111 0.713444553483807 0.017888888888889 0.018645731108929],...
    'String',{'1'},...
    'FontWeight','bold',...
    'FontSize',20,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'textbox',...
    [0.809888888888889 0.70755642787046 0.0223333333333333 0.0245338567222732],...
    'String',{'2'},...
    'FontWeight','bold',...
    'FontSize',20,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'textbox',...
    [0.205444444444444 0.410206084396467 0.0201111111111111 0.0225711481844937],...
    'String',{'1'},...
    'FontWeight','bold',...
    'FontSize',20,...
    'FitBoxToText','off',...
...
annotation(gcf,'textbox',...
    ...
    'EdgeColor','none');
annotation(gcf,'textbox',...
    [0.367666666666667 0.411187438665358 0.0167777777777778 0.0215897939156026],...
    'String',{'2'},...
    'FontWeight','bold',...
    'FontSize',20,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'textbox',...
    [0.646555555555556 0.409224730127576 0.0201111111111112 0.0235525024533845],...
    'String',{'1'},...
    'FontWeight','bold',...
    'FontSize',20,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'textbox',...
    [0.812111111111111 0.408243375858685 0.019 0.0245338567222763],...
    'String',{'2'},...
    'FontWeight','bold',...
    'FontSize',20,...
    'FitBoxToText','off',...
...
annotation(gcf,'textbox',...
    [0.209888888888889 0.1099116781158 0.019 0.0225711481844943],'String',{'1'},...
    'FontWeight','bold',...
    'FontSize',20,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'textbox',...
    [0.368777777777778 0.108930323846909 0.0212222222222223 0.0235525024533852],...
    'String',{'2'},...
    'FontWeight','bold',...
    'FontSize',20,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'textbox',...
    [0.652111111111111 0.108930323846908 0.0189999999999999 0.0235525024533853],...
    'String',{'1'},...
    'FontWeight','bold',...
    'FontSize',20,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'textbox',...
    [0.812111111111111 0.112855740922473 0.017888888888889 0.0196270853778208],...
    'String',{'2'},...
    'FontWeight','bold',...
    'FontSize',20,...
    'FitBoxToText','off',...
...
subplot(3,2,6); imagesc(x,t,d_d7);colormap(amf_seis);hold on
text(n1/-40,-0.2,'(f)','color','k','Fontsize',18,'fontweight','bold','HorizontalAlignment','center');
text(n2/3.5,-0.08,'DRR','color','k','Fontsize',16,'fontweight','bold','HorizontalAlignment','center');
text(n2/1.3,-0.08,'Removed noise','color','k','Fontsize',16,'fontweight','bold','HorizontalAlignment','center');
colormap(amf_seis);caxis([-0.6,0.6]);
ylabel('Time (s)','Fontsize',16,'fontweight','bold');
...
annotation(gcf,'textarrow',[0.827777777777778 0.823333333333334],...
    [0.210009813542689 0.242445315652351],'Color',[1 0 0],'TextColor',[1 0 0],...
    'String',{'Visible','signal',' leakage'},...
    'LineWidth',3,...
    'HeadWidth',25,...
    'HeadLength',15,...
    'FontWeight','bold',...
    'FontSize',18);
annotation(gcf,'textarrow',[0.714444444444444 0.697777777777778],...
    [0.253273090468908 0.281699486407994],'Color',[1 0 0],'TextColor',[1 0 0],...
    'LineWidth',3,...
    'HeadWidth',25,...
    'HeadLength',15,...
    'FontWeight','bold',...
    'FontSize',18);
annotation(gcf,'textarrow',[0.654444444444444 0.68],...
    [0.134445534838076 0.154123431452154],'Color',[1 0 0],'TextColor',[1 0 0],...
    'LineWidth',3,...
    'HeadWidth',25,...
    'HeadLength',15,...
    'FontWeight','bold',...
    'FontSize',18);
annotation(gcf,'textarrow',[0.591111111111111 0.603333333333334],...
    [0.262021589793915 0.284643549214667],'Color',[1 0 0],'TextColor',[1 0 0],...
    'LineWidth',3,...
    'HeadWidth',25,...
    'HeadLength',15,...
    'FontWeight','bold',...
...
annotation(gcf,'textbox',...
    [0.203222222222222 0.710500490677134 0.0223333333333333 0.0225711481844906],...
    'String',{'1'},...
    'FontWeight','bold',...
    'FontSize',20,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'textbox',...
    [0.369888888888889 0.708537782139351 0.019 0.0235525024533838],...
    'String',{'2'},...
    'FontWeight','bold',...
    'FontSize',20,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'textbox',...
    [0.651 0.713444553483807 0.019 0.01962708537782],'String',{'1'},...
    'FontWeight','bold',...
    'FontSize',20,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'textbox',...
    [0.809888888888889 0.708537782139351 0.0212222222222223 0.0245338567222751],...
    'String',{'2'},...
    'FontWeight','bold',...
    'FontSize',20,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'textbox',...
    [0.206555555555556 0.410206084396467 0.0212222222222222 0.0225711481844935],...
    'String',{'1'},...
    'FontWeight','bold',...
    'FontSize',20,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'textbox',...
    [0.369888888888889 0.409224730127576 0.0256666666666667 0.0235525024533839],...
    'String','2',...
    'FontWeight','bold',...
    'FontSize',20,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'textbox',...
    [0.647666666666667 0.411187438665358 0.0245555555555556 0.0215897939156023],...
    'String',{'1'},...
    'FontWeight','bold',...
    'FontSize',20,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'textbox',...
    [0.809888888888889 0.412168792934249 0.0245555555555556 0.0206084396467106],...
    'String',{'2'},...
    'FontWeight','bold',...
    'FontSize',20,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'textbox',...
    [0.211 0.107948969578017 0.019 0.0255152109911677],'String',{'1'},...
    'FontWeight','bold',...
    'FontSize',20,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'textbox',...
    [0.369888888888889 0.110893032384691 0.0201111111111111 0.0215897939156036],...
    'String',{'2'},...
    'FontWeight','bold',...
    'FontSize',20,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'textbox',...
    [0.644333333333333 0.109911678115799 0.0245555555555556 0.0235525024533854],...
    'String',{'1'},...
    'FontWeight','bold',...
    'FontSize',20,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'textbox',...
    [0.807666666666667 0.1099116781158 0.0223333333333333 0.0225711481844943],...
    'String',{'2'},...
    'FontWeight','bold',...
    'FontSize',20,...
    'FitBoxToText','off',...
