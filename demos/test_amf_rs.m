...
subplot(5,1,1); imagesc(x,t,d1_11);colormap(amf_seis);hold on
...
subplot(5,1,2); imagesc(x,t,d1_21);colormap(amf_seis);hold on
...
colormap(amf_seis);caxis([-0.4,0.4]);
annotation(gcf,'rectangle',...
    [0.12965811965812 0.716021184435628 0.774684210526315 0.0160906422577708],...
    'LineWidth',3);
...
inds1=125:250;
% figure('units','normalized','Position',[0.0 0.0 0.5, 1],'color','w');
subplot(5,1,3);amf_imagesc(d1_11(inds1,:),25,2,x,t(inds1));
ylabel('Time (s)','Fontsize',16,'fontweight','bold');
xlabel('Trace','Fontsize',16,'fontweight','bold');
set(gca,'Linewidth',2,'Fontsize',12,'Fontweight','bold');
colormap(amf_seis);caxis([-0.4,0.4]);
...
subplot(5,1,4);amf_imagesc(d1_21(inds1,:),25,2,x,t(inds1));
ylabel('Time (s)','Fontsize',16,'fontweight','bold');
...
subplot(5,1,5);amf_imagesc(d1_sim1(inds1,:),25,2,x,t(inds1)); colormap(jet);
...
figure('units','normalized','Position',[0.0 0.0 0.5, 1],'color','w');
subplot(5,1,1); imagesc(x,t,d2_1);colormap(amf_seis);hold on
...
xlabel('Trace','Fontsize',16,'fontweight','bold');
set(gca,'Linewidth',2,'Fontsize',12,'Fontweight','bold');
subplot(5,1,2); imagesc(x,t,d2_2);colormap(amf_seis);hold on
...
% figure('units','normalized','Position',[0.0 0.0 0.5, 1],'color','w');
subplot(5,1,3);amf_imagesc(d2_1(inds1,:),25,2,x,t(inds1));
ylabel('Time (s)','Fontsize',16,'fontweight','bold');
xlabel('Trace','Fontsize',16,'fontweight','bold');
set(gca,'Linewidth',2,'Fontsize',12,'Fontweight','bold');
colormap(amf_seis);caxis([-0.4,0.4]);
...
subplot(5,1,4);amf_imagesc(d2_2(inds1,:),25,2,x,t(inds1));
...
subplot(5,1,5);amf_imagesc(d_sim2(inds2,:),25,2,x,t(inds2)); colormap(jet);
