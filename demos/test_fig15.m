...
% 
par.w=0.06;              % half width (in percentage) of the cone filter (i.e., w*nk=nwidth)
%
...
par.c1=1;                % Type of the transform(0: complex-valued curvelets,1: real-valued curvelets)
par.c2=1;                % Chooses one of two possibilities for the coefficients at the finest level(1: curvelets,2: wavelets)
c3=7;                 % Thresholding parameter (alpha)
par.niter1=10;           % Number of iteration
%
rec = zeros(3, 1);       % 3-D vector denoting smooth radius 
par.rec(1) = 50;
...
text(n2/1.2,-0.03,'Raw data','color','k','Fontsize',13,'fontweight','bold','HorizontalAlignment','center');
text(n2/0.38,-0.03,'AMF','color','k','Fontsize',13,'fontweight','bold','HorizontalAlignment','center');
text(n2/0.23,-0.03,'Removed noise','color','k','Fontsize',13,'fontweight','bold','HorizontalAlignment','center');
