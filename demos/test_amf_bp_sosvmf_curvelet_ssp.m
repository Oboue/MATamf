...
%
tic
d2_bp=amf_bandpass(d2dssp_nmo,dt,flo,fhi,nplo,nphi,phase,verb0);
toc
%
...
% 
tic
d_curvelet=amf_curvelet(d2dssp_nmo,d_est,n1,n2,c1,c2,c3,niter1);
toc
%
%% AMF
% dt=0.0005; % sampling
...
annotation(gcf,'textbox',...
    ...
    'BackgroundColor',[1 1 1]);
%
subplot(3,2,4); imagesc(1:nh,t,reshape(d_curvelet,n1,nh)); hold on;
...
print(gcf,'-depsc','-r300','fig25.eps');
