...
annotation(gcf,'textbox',...
    ...
    'EdgeColor','none',...
    'BackgroundColor',[1 1 1]);
annotation(gcf,'textarrow',[0.172222222222222 0.153333333333333],...
    [0.756172839506178 0.778806584362145],'Color',[0 0 1],'TextColor',[0 0 1],...
    'LineWidth',3,...
    'HeadWidth',15,...
    'HeadLength',15,...
    'FontWeight','bold',...
...
annotation(gcf,'textarrow',[0.616666666666667 0.597777777777778],...
    [0.75617283950618 0.778806584362147],'Color',[0 0 1],'TextColor',[0 0 1],...
    'LineWidth',3,...
    'HeadWidth',15,...
    'HeadLength',15,...
    'FontWeight','bold',...
...
annotation(gcf,'textbox',...
    ...
    'EdgeColor','none',...
    'BackgroundColor',[1 1 1]);
annotation(gcf,'textarrow',[0.174444444444444 0.155555555555555],...
    [0.454732510288067 0.477366255144035],'Color',[0 0 1],'TextColor',[0 0 1],...
    'LineWidth',3,...
    'HeadWidth',15,...
    'HeadLength',15,...
    'FontWeight','bold',...
...
annotation(gcf,'textbox',...
    ...
    'BackgroundColor',[1 1 1]);
annotation(gcf,'textarrow',[0.616666666666667 0.597777777777778],...
    [0.454732510288066 0.477366255144034],'Color',[0 0 1],'TextColor',[0 0 1],...
    'String',{'Weaker signal energgy'},...
    'LineWidth',3,...
    'HeadWidth',15,...
    'HeadLength',15,...
    'FontWeight','bold',...
...
annotation(gcf,'textbox',...
    ...
    'EdgeColor','none',...
    'BackgroundColor',[1 1 1]);
annotation(gcf,'textarrow',[0.18 0.161111111111111],...
    [0.156378600823047 0.179012345679014],'Color',[0 0 1],'TextColor',[0 0 1],...
    'String',{'Improved signal energgy'},...
    'LineWidth',3,...
    'HeadWidth',15,...
    'HeadLength',15,...
    'FontWeight','bold',...
