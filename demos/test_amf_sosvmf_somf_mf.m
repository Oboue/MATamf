...
comp1=[din,d1,din-d1,d2,din-d2]; 

comp2=[din,d3,din-d3,d4,din-d4]; 
% combined figure
...
text((n2*2+ngap*3)/2+n2,-0.02,'MF','color','k','Fontsize',16,'fontweight','bold','HorizontalAlignment','center');
text((n2*2+ngap*3)/2+n2*3+ngap*2,-0.02,'SOMF','color','k','Fontsize',16,'fontweight','bold','HorizontalAlignment','center');
text(-200,-0.02,'(a)','color','k','Fontsize',18,'fontweight','bold','HorizontalAlignment','center');
text(50,0.46,labels{4},'color','b','Fontsize',16,'fontweight','bold','HorizontalAlignment','left');
hold on;
...
text(n2/2,-0.02,'Raw','color','k','Fontsize',16,'fontweight','bold','HorizontalAlignment','center');
text((n2*2+ngap*3)/2+n2,-0.02,'SOSVMF','color','k','Fontsize',18,'fontweight','bold','HorizontalAlignment','center');
text((n2*2+ngap*3)/2+n2*3+ngap*2,-0.02,'AMF','color','k','Fontsize',16,'fontweight','bold','HorizontalAlignment','center');
text(-200,-0.02,'(b)','color','k','Fontsize',18,'fontweight','bold','HorizontalAlignment','center');
text(50,0.46,labels{4},'color','b','Fontsize',16,'fontweight','bold','HorizontalAlignment','left');
...
annotation(gcf,'textbox',...
    [0.19637037037037 0.582924435721289 0.0249259259259259 0.0294406280667372],...
    'String',{'1'},...
    'FontWeight','bold',...
    'FontSize',25,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'line',[0.284259259259259 0.284259259259259],...
    [0.924435721295387 0.582924435721295],'LineWidth',3);
annotation(gcf,'line',[0.437962962962963 0.437962962962963],...
    [0.923454367026497 0.584887144259078],'LineWidth',3);
annotation(gcf,'textbox',...
    [0.351000000000001 0.583905789990185 0.0184444444444444 0.0284592737978395],...
    'String',{'2'},...
    'FontWeight','bold',...
    'FontSize',25,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'textbox',...
    [0.50562962962963 0.582924435721292 0.0156666666666668 0.0294406280667333],...
    'String','3',...
    'FontWeight','bold',...
    'FontSize',25,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'line',[0.597222222222222 0.596296296296296],...
    [0.923435721295387 0.582924435721295],'LineWidth',3);
annotation(gcf,'textbox',...
    [0.66025925925926 0.58684985279686 0.0193703703703695 0.0245338567222744],...
    'String',{'4'},...
    'FontWeight','bold',...
    'FontSize',25,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'line',[0.75 0.750925925925926],...
    [0.924435721295387 0.582924435721295],'LineWidth',3);

annotation(gcf,'textbox',...
    [0.817666666666667 0.584887144259078 0.018444444444444 0.0274779195289468],...
    'String',{'5'},...
    'FontWeight','bold',...
    'FontSize',25,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'textbox',...
    [0.195444444444445 0.105004906771344 0.0212222222222219 0.0323846908734048],...
    'String',{'1'},...
    'FontWeight','bold',...
    'FontSize',25,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'line',[0.285185185185185 0.285185185185185],...
    [0.448478900883219 0.108930323846909],'LineWidth',3);
annotation(gcf,'textbox',...
    [0.352851851851852 0.107948969578018 0.0156666666666666 0.0294406280667317],...
    'String',{'2'},...
    'FontWeight','bold',...
    'FontSize',25,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'textbox',...
    [0.506555555555556 0.112855740922473 0.0221481481481479 0.0255152109911676],...
    'String',{'3'},...
    'FontWeight','bold',...
    'FontSize',25,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'line',[0.595370370370371 0.594444444444444],...
    [0.44946025515211 0.107948969578018],'LineWidth',3);
annotation(gcf,'textbox',...
    [0.658407407407408 0.11972522080471 0.0165925925925925 0.0166830225711479],...
    'String',{'4'},...
    'FontWeight','bold',...
    'FontSize',25,...
    'FitBoxToText','off',...
...
annotation(gcf,'line',[0.75 0.750925925925926],...
    [0.44946025515211 0.107948969578018],'LineWidth',3);
annotation(gcf,'textbox',...
    [0.815814814814815 0.110893032384691 0.0184444444444439 0.0264965652600586],...
    'String',{'5'},...
    'FontWeight','bold',...
    'FontSize',25,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'line',[0.440740740740741 0.440740740740741],...
