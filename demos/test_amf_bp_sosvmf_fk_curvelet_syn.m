...
% Script to plot Figures 19 and 20
...
subplot(3,2,4); imagesc(x,t,d1_d4);colormap(amf_seis);hold on
text(n1/-40,-0.2,'(d)','color','k','Fontsize',16,'fontweight','bold','HorizontalAlignment','center');
text(n2/3.5,-0.08,'FK','color','k','Fontsize',16,'fontweight','bold','HorizontalAlignment','center');
text(n2/1.3,-0.08,'Removed noise','color','k','Fontsize',16,'fontweight','bold','HorizontalAlignment','center');
colormap(amf_seis);caxis([-0.6,0.6]);
ylabel('Time (s)','Fontsize',12,'fontweight','bold');
xlabel('Trace','Fontsize',12,'fontweight','bold');
...
subplot(3,2,5); imagesc(x,t,d1_d5);colormap(amf_seis);hold on
...
subplot(3,2,6); imagesc(x,t,d1_d6);colormap(amf_seis);hold on
text(n1/-40,-0.2,'(f)','color','k','Fontsize',16,'fontweight','bold','HorizontalAlignment','center');
