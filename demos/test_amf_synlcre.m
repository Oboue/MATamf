...
%%
ngap=5;
d_1l=[dcl,dinl,d1l,dinl-d1l,d2l,dinl-d2l];
d_2l=[d4l,d4l-dinl,d5l,dinl-d5l];
...
d_siml=[simid1,simid2,simid4,simid5];
...
%%
ngap=5;
d_1=[dc,din,d1,din-d1,d2,din-d2];
d_2=[d4,d4-din,d5,din-d5];
%% Numerical test using signal-to-noise ratio (S/N) 
amf_snr(dc,dn) % Noisy
amf_snr(dc,d1) % BP
...
d_sim=[simid1,simid2,simid4,simid5];
...
ax(1)=subplot(3,1,1); imagesc(x,t,d_1l);colormap(ax(1),amf_seis);hold on
...
annotation(gcf,'textbox',...
    [0.173333333333333 0.711481844946016 0.0233333333333333 0.0255152109911673],...
    'String','1',...
    'FontWeight','bold',...
    'FontSize',25,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'textbox',...
    [0.309999999999999 0.71148184494601 0.0233333333333335 0.0255152109911673],...
    'String','2',...
    'FontWeight','bold',...
    'FontSize',25,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'textbox',...
    [0.436666666666666 0.711481844946012 0.0233333333333335 0.0255152109911673],...
    'String','3',...
    'FontWeight','bold',...
    'FontSize',25,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'textbox',...
    [0.566666666666666 0.711481844946011 0.0233333333333333 0.0255152109911673],...
    'String','4',...
    'FontWeight','bold',...
    'FontSize',25,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'textbox',...
    [0.707777777777778 0.711481844946013 0.0233333333333333 0.0255152109911673],...
    'String','5',...
    'FontWeight','bold',...
    'FontSize',25,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'textbox',...
    [0.828888888888889 0.711481844946014 0.0233333333333333 0.0255152109911673],...
    'String','6',...
    'FontWeight','bold',...
    'FontSize',25,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'line',[0.258888888888889 0.257777777777778],...
    [0.923435721295387 0.708537782139352],'LineWidth',2);
annotation(gcf,'line',[0.387777777777778 0.386666666666667],...
    [0.924417075564273 0.709519136408236],'LineWidth',2);
annotation(gcf,'line',[0.518888888888889 0.517777777777778],...
    [0.924417075564268 0.70951913640823],'LineWidth',2);
annotation(gcf,'line',[0.645555555555556 0.644444444444445],...
    [0.923435721295378 0.708537782139343],'LineWidth',2);
annotation(gcf,'line',[0.777777777777778 0.776666666666667],...
    [0.92441707556427 0.709519136408233],'LineWidth',2);
annotation(gcf,'textarrow',[0.441111111111112 0.47],...
    [0.822542309504839 0.841020608439646],'Color',[1 0 0],...
...
annotation(gcf,'textbox',...
    [0.643222222222222 0.736015701668298 0.133444444444444 0.0607502096891688],...
    'Color',[1 0 0],...
    ...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'textarrow',[0.834444444444445 0.852222222222222],...
    [0.850183534609499 0.886572816712633],'Color',[1 0 0],...
...
ax(2)=subplot(3,1,2); imagesc(x,t,d_2l);colormap(ax(2),amf_seis);hold on
...
set(gca,'XTick',0)
annotation(gcf,'textbox',...
    [0.213333333333333 0.412168792934238 0.0233333333333333 0.0255152109911669],...
    'String','1',...
    'FontWeight','bold',...
    'FontSize',25,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'textbox',...
    [0.405555555555555 0.412168792934233 0.0233333333333334 0.0255152109911674],...
    'String','2',...
    'FontWeight','bold',...
    'FontSize',25,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'textbox',...
    [0.604444444444444 0.412168792934232 0.0233333333333333 0.0255152109911674],...
    'String','3',...
    'FontWeight','bold',...
    'FontSize',25,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'textbox',...
    [0.797777777777777 0.41216879293423 0.0233333333333333 0.0255152109911674],...
    'String','4',...
    'FontWeight','bold',...
    'FontSize',25,...
    'FitBoxToText','off',...
    'EdgeColor','none');
annotation(gcf,'line',[0.323333333333333 0.322222222222222],...
    [0.625104023552495 0.41020608439646],'LineWidth',2);
annotation(gcf,'line',[0.517777777777778 0.516666666666667],...
    [0.625104023552499 0.410206084396464],'LineWidth',2);
annotation(gcf,'line',[0.71 0.708888888888889],...
    [0.624122669283607 0.409224730127573],'LineWidth',2);
annotation(gcf,'textarrow',[0.38 0.39],...
    [0.552828977775863 0.586196015187395],'Color',[1 0 0],...
    'String',{'Visible','signal','leakage'},...
    'LineWidth',3,...
    'HeadWidth',20,...
    'HeadLength',15,...
    ...
    'FontSize',18,...
    'FontName','Helvetica Neue');
annotation(gcf,'textarrow',[0.422222222222222 0.438888888888889],...
    [0.605096138198352 0.586386818089218],'Color',[1 0 0],'LineWidth',3,...
    'HeadWidth',20,...
    'HeadLength',15,...
    'FontWeight','bold',...
    'FontSize',18,...
...
% %
% figure('units','normalized','Position',[0.0 0.0 0.5, 1],'color','w');
ax(3)=subplot(3,1,3); imagesc(x,t,d_siml);colormap(ax(3),jet);hold on
...
annotation(gcf,'line',[0.311111111111111 0.31],...
    [0.323828263002933 0.108930323846898],'LineWidth',2);
annotation(gcf,'line',[0.493333333333333 0.492222222222222],...
    [0.324809617271825 0.109911678115791],'LineWidth',2);
annotation(gcf,'line',[0.675555555555555 0.674444444444444],...
    [0.324809617271825 0.109911678115792],'LineWidth',2);
...
annotation(gcf,'textbox',...
    [0.2 0.112855740922459 0.0233333333333334 0.0255152109911666],...
    'Color',[1 1 1],...
    'String','1',...
    'FontWeight','bold',...
    'FontSize',25,...
    ...
    'EdgeColor','none');
annotation(gcf,'textbox',...
    [0.381111111111111 0.112855740922457 0.0233333333333334 0.0255152109911674],...
    'Color',[1 1 1],...
    'String','2',...
    'FontWeight','bold',...
    'FontSize',25,...
    ...
    'EdgeColor','none');
annotation(gcf,'textbox',...
    [0.567777777777778 0.112855740922457 0.0233333333333331 0.0255152109911673],...
    'Color',[1 1 1],...
    'String','3',...
    'FontWeight','bold',...
    'FontSize',25,...
    ...
    'EdgeColor','none');
annotation(gcf,'textbox',...
    [0.745555555555555 0.111874386653565 0.0233333333333333 0.0255152109911672],...
    'Color',[1 1 1],...
    'String','4',...
    'FontWeight','bold',...
    'FontSize',25,...
...
figure('units','normalized','Position',[0.0 0.0 0.5, 1],'color','w');
ax(1)=subplot(3,1,1); imagesc(x,t,d_1);colormap(ax(1),amf_seis);hold on
text(n1/-70,-0.1,'(a)','color','k','Fontsize',20,'fontweight','bold','HorizontalAlignment','center');
text(n2/9.5,-0.07,'Clean','color','k','Fontsize',16,'fontweight','bold','HorizontalAlignment','center');
text(n2/4,-0.07,'Raw','color','k','Fontsize',16,'fontweight','bold','HorizontalAlignment','center');
text(n2/2.0,-0.07,'BP','color','k','Fontsize',16,'fontweight','bold','HorizontalAlignment','center');
...
annotation(gcf,'textarrow',[0.436666666666667 0.475555555555555],...
    [0.85669065778798 0.879282586676439],'Color',[1 0 0],'TextColor',[1 0 0],...
    'String',{'High-amplitude','erratic noise'},...
    'LineWidth',3,...
    'HeadWidth',25,...
    'HeadLength',15,...
...
ax(2)=subplot(3,1,2); imagesc(x,t,d_2);colormap(ax(2),amf_seis);hold on
text(n1/-70,-0.1,'(b)','color','k','Fontsize',20,'fontweight','bold','HorizontalAlignment','center');
text(n2/4,-0.07,'BP+SOSVMF+Curvelet','color','k','Fontsize',16,'fontweight','bold','HorizontalAlignment','center');
text(n2/1.30,-0.07,'AMF','color','k','Fontsize',16,'fontweight','bold','HorizontalAlignment','center');
colormap(amf_seis);caxis([-0.6,0.6]);
...
%
ax(3)=subplot(3,1,3); imagesc(x,t,d_sim);colormap(ax(3),jet);hold on
text(n1/-70,-0.1,'(c)','color','k','Fontsize',20,'fontweight','bold','HorizontalAlignment','center');
