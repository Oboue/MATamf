...
set(gca,'Linewidth',2,'Fontsize',16,'Fontweight','bold');
annotation(gcf,'textarrow',[0.387777777777778 0.397777777777778],...
    [0.351894965220442 0.385262002631972],'Color',[1 0 0],...
    'String',{'Visible','signal','leakage'},...
    'LineWidth',3,...
    'HeadWidth',20,...
    'HeadLength',15,...
    ...
    'FontSize',18,...
    'FontName','Helvetica Neue');
annotation(gcf,'textarrow',[0.413333333333334 0.432222222222223],...
    [0.435804853387267 0.392315470171894],'Color',[1 0 0],'LineWidth',3,...
    'HeadWidth',20,...
    'HeadLength',15,...
    'FontWeight','bold',...
    'FontSize',18,...
    'FontName','Helvetica Neue');
annotation(gcf,'textarrow',[0.775555555555555 0.793333333333333],...
    [0.345857645151954 0.382246927255087],'Color',[1 0 0],'LineWidth',3,...
    'HeadWidth',20,...
    'HeadLength',15,...
    'FontWeight','bold',...
    'FontSize',18,...
...
annotation(gcf,'textarrow',[0.812222222222223 0.831111111111111],...
    [0.4378453897394 0.394356006524027],'Color',[1 0 0],'LineWidth',3,...
    'HeadWidth',20,...
    'HeadLength',15,...
    'FontWeight','bold',...
    'FontSize',18,...
...
text(n2/7,-0.02,'BP','color','k','Fontsize',16,'fontweight','bold','HorizontalAlignment','center');
text(n2/2.8,-0.02,'BP+SOSVMF','color','k','Fontsize',16,'fontweight','bold','HorizontalAlignment','center');
%text(n2/2,-0.02,'BP+SOSVMF+FK','color','k','Fontsize',10,'fontweight','bold','HorizontalAlignment','center');
text(n2/1.6,-0.02,'BP+SOSVMF+Curvelet','color','k','Fontsize',16,'fontweight','bold','HorizontalAlignment','center');
text(n2/1.15,-0.02,'AMF','color','k','Fontsize',16,'fontweight','bold','HorizontalAlignment','center');
...
annotation(gcf,'textarrow',[0.47 0.415555555555556],...
    [0.641051567239636 0.721608040201005],'Color',[1 0 0],'TextColor',[1 0 0],...
    'LineWidth',3,...
    'HeadWidth',30,...
    'HeadLength',15,...
    'FontWeight','bold',...
    'FontSize',25);
annotation(gcf,'textarrow',[0.47 0.552222222222222],...
    [0.640051567239637 0.764824120603015],'Color',[1 0 0],'TextColor',[1 0 0],...
    'String',{'Visible','  signal','leakage'},...
    'LineWidth',3,...
    'HeadWidth',30,...
    'HeadLength',15,...
    'FontWeight','bold',...
    'FontSize',25);
annotation(gcf,'textarrow',[0.471111111111111 0.601111111111111],...
    [0.640040444893833 0.721608040201005],'Color',[1 0 0],'TextColor',[1 0 0],...
    'LineWidth',3,...
    'HeadWidth',30,...
    'HeadLength',15,...
    'FontWeight','bold',...
...
xlabel('Trace','Fontsize',16,'fontweight','bold');
set(gca,'Linewidth',2,'Fontsize',16,'Fontweight','bold');
annotation(gcf,'textarrow',[0.477777777777778 0.507777777777778],...
    [0.205839802390868 0.245245245245245],'Color',[1 0 0],'TextColor',[1 0 0],...
    'String',{'Visible','signal','leakage'},...
    'LineWidth',3,...
    'HeadWidth',25,...
    'HeadLength',15,...
...
annotation(gcf,'arrow',[0.474444444444444 0.313333333333333],...
    [0.302512562814071 0.433165829145729],'Color',[1 0 0],'LineWidth',3,...
    'HeadWidth',25,...
    'HeadLength',15);
annotation(gcf,'textarrow',[0.474444444444447 0.476666666666669],...
    [0.303353923307134 0.37715473220501],'Color',[1 0 0],'TextColor',[1 0 0],...
    'String',{'Visible','signal','leakage'},...
    'LineWidth',3,...
    'HeadWidth',25,...
    'HeadLength',15,...
    'FontWeight','bold',...
    'FontSize',25);
annotation(gcf,'arrow',[0.473333333333333 0.652222222222222],...
    [0.303366117747485 0.396984924623116],'Color',[1 0 0],'LineWidth',3,...
    'HeadWidth',25,...
    'HeadLength',15);
