...
tic
d_bp1=amf_bp(dinl,dt,flo,fhi,nplo,nphi,phase,verb);
toc
...
d_ct1=amf_ct(dinl,d_est,n1,n2,c1,c2,c3,niter1);
%% AMF method
...
d1_d5=[d_ct1,zeros(n1,ngap),dnl-d_ct1]; % Curvelet
...
%
tic
d_bp=amf_bp(din,dt,flo,fhi,nplo,nphi,phase,verb);
toc
%
%% Denoising using the SOSVMF method
...
dout=amf_ct(din,d_est,n1,n2,c1,c2,c3,niter1);
d_ct=dout;
...
d_d5=[d_ct,zeros(n1,ngap),dn-d_ct]; % Curvelet
