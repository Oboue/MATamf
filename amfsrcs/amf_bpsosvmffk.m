function [dout] = amf_bpsosvmffk(din,dt,flo,fhi,nplo,nphi,phase,verb0,niter,liter,order1,eps_dv, eps_cg, tol_cg,rect,verb1,adj,add,n1,n2,ns,order2,eps,ndn,nds,type_mf,ifsmooth,w)
% amf_bpsosvmffk : BP+SOSVMF+FK method 
%
% By Oboue et al., 2022
%
% INPUT
