function [d,h,t] = amf_levents(dt,f0,tmax,h,tau,p,amp,snr,L,seed);
% AMF_LEVENTS: A program to generate data containing linear events.
%
% [d] = amf_levents(dt,f0,tmax,h,tau,p,amp,snr,L,seed);
%
