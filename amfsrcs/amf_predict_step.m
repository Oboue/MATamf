function [w,diag,offd,trace] = amf_predict_step(e,nw,adj,forw,n1,pp,trace)
...
[diag,offd] = amf_regularization(diag,offd,nw,eps,eps2);
...
[w,diag,offd] = amf_pwd_define(forw,diag,offd,n1,nw,pp);
% [diag,offd]
   
if adj
   trace = amf_banded_solve(n1,nb,diag,offd,trace);
end
...
[trace] = amf_pwd_set(adj,w,diag,offd,pp,trace);%?
