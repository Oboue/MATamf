function [w,diag,offd] = amf_pwd_define(forw,diag,offd,n1,nw,pp)
%amf_pwd_define: matrix multiplication
%
% INPUT:
%
...
function [a,b] = amf_passfilter(p,nw)
% amf_passfilter: find filter coefficients��verfied)
